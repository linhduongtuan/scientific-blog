...
echo "1. Open another browser (or incognito window)"
echo "2. Sign in with different test accounts:"
echo "   - admin@example.com / admin123"
echo "   - alice@example.com / alice123"
echo "   - bob@example.com / bob123"
echo "3. Test real-time messaging between users"
echo "4. Try reactions, file uploads, and channel switching"
echo ""
echo "🔧 Create additional test users:"
echo "node scripts/create-chat-test-users.js"
echo ""
